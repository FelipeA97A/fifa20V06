...
public class BDController {
	...
	public BDController() {
		try {
			...
			this.miConexion = DriverManager.getConnection("jdbc:mysql://localhost/fifa2", "root", "");
			//this.miConexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/fifa2", "root", "");
